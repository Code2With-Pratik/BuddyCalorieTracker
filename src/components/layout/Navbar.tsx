      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center bg-white/95 backdrop-blur-sm px-3 py-2 rounded-full shadow-lg border border-white ml-24">
          <ul className="flex items-center gap-1">
            <li><a href="#" className="px-5 py-2 rounded-full font-bold text-gray-700 hover:text-brand-orange transition">Home</a></li>
            <li><a href="#" className="px-5 py-2 rounded-full font-medium text-gray-500 hover:text-brand-orange transition">Meet Buddy</a></li>
            <li><a href="#" className="px-5 py-2 rounded-full font-medium text-gray-500 hover:text-brand-orange transition">Features</a></li>
            <li><a href="#" className="px-5 py-2 rounded-full font-medium text-gray-500 hover:text-brand-orange transition">Blog</a></li>
            <li>
        ...
        <div className="flex items-center gap-4 translate-x-18">
          ...
          <div className="flex items-center pr-2 pl-1.5 py-1.5 cursor-pointer">
