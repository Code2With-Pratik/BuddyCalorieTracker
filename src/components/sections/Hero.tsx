...
const Hero: React.FC = () => {
  ...
  const handleScrollDown = () => {
    const section = document.getElementById('meetbuddy');
    
    if (section) {
      // Get position relative to viewport + current scroll position
    ...
    <section id='hero' className="relative w-full min-h-screen bg-white flex items-center justify-center overflow-hidden py-10">
      <div className="relative -mt-6 w-full max-w-371.25 aspect-video lg:aspect-auto lg:h-screen mx-auto">
        ...
        <div className="absolute left-6 top-80 -translate-y-1/2 hidden xl:flex flex-col items-center gap-5">
          ...
          {/* Right: Scroll Down (UPDATED WITH CLICK EVENT) */}
          <div className="absolute right-6 top-1/2 -translate-y-1/2 hidden xl:flex flex-col items-center gap-6">
            ...
            <div 
              onClick={handleScrollDown} // Added Click Handler
              className="w-12 h-12 bg-brand-dark rounded-full border border-[#451a03]/20 flex items-center justify-center cursor-pointer hover:bg-brand-orange transition active:scale-95"
            >
              <span className="text-[#ffffff] text-2xl animate-bounce mt-1">↓</span> 
            </div>
          </div>
          ...
          <div className="grow grid grid-cols-1 lg:grid-cols-2 gap-8 items-center px-12 lg:px-24 pt-20 pb-32">
            ...
            <div className="relative flex justify-center items-center h-full">
              ...
              <div className="absolute right-18 bottom-22 z-30 w-55 p-1 bg-white rounded-2xl shadow-card">
                <div className="relative flex flex-col items-center justify-center">
                  <div className="w-02 h-23 overflow-hidden">
                    <svg viewBox="0 0 200 110" className="w-full h-full">
                      <path d="M 30 101 A 70 70 0 0 1 61 40" fill="none" stroke="#4FB201" strokeWidth="35" />
                      <path d="M 64 38 A 70 70 0 0 1 136 38" fill="none" stroke="#FEB62A" strokeWidth="35" />
                      <path d="M 139 40 A 70 70 0 0 1 171 100" fill="none" stroke="#FE6D2F" strokeWidth="35" />
                    </svg>
                  </div>
        ...
        <div className="left-0 bottom-35 z-40 bg-[#451a03] w-94 h-35 rounded-[40px] flex items-center px-10 relative overflow-hidden">
          ...
          <img src="/images/broccoli.png" alt="Broccoli" className="absolute top-3 right-24 w-10 object-contain -rotate-12 opacity-90" />
          <img src="/images/Strawberry.png" alt="Strawberry" className="absolute -top-6 -right-5 w-24 object-contain rotate-12" />
          <img src="/images/apple.png" alt="Apple" className="absolute -bottom-2.5 right-24 w-18 object-contain rotate-6" />
          <img src="/images/banana.png" alt="Banana" className="absolute -bottom-8 -right-8 w-28 object-contain -rotate-58" />
        </div>
